tell application "System Events" to tell application process "NotificationCenter"
        try
                # log (actions of UI elements of UI element 1 of scroll area 1 of group 1 of group 1 of window "Notification Center" of application process "NotificationCenter" of application "System Events")
